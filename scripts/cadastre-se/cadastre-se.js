...
formularioCadastro.addEventListener('submit', (e)=>{
    ...
    localStorage.setItem('usuarios', JSON.stringify([...usuarios, {nomeCompleto:inputNome.value, endereco:inputEndereco.value, CPF:inputCPF.value,email:inputEmail.value, senha:inputSenha.value}]))
